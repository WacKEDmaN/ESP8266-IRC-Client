...
LiquidCrystal_I2C lcd(0x3F, 16, 2);  // LCD backpack address
int diplayTime = 10;      // how long show info on LCD before returning to in seconds
...
void callback(IRCMessage ircMessage) {
  ...
  // Channels to JOIN  *Edit Channels*
